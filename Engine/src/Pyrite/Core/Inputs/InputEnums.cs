namespace Pyrite.Core.Inputs
{
    ...
    public static class KeysExtentions
    {
        public static Microsoft.Xna.Framework.Input.Keys ToXna(this Keys keys) 
        => (Microsoft.Xna.Framework.Input.Keys)keys;
        public static Keys ToPyrite(this Microsoft.Xna.Framework.Input.Keys keys) 
        => (Keys)keys;
    }
    
    public static class GamepadExtentions
    {
        public static Microsoft.Xna.Framework.Input.Buttons ToXna(this GamepadButtons button) 
            => (Microsoft.Xna.Framework.Input.Buttons)button;
        public static GamepadButtons ToPyrite(this Microsoft.Xna.Framework.Input.Buttons button) 
